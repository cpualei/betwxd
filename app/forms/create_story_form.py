...
class CreateStoryForm(FlaskForm):
    ...
    img = StringField('Image', validators=[DataRequired("*Please provide an image in PNG, JPG or JPEG format."), Regexp("/(https?:\/\/.*\.(?:png|jpg|jpeg))/i", message="*Please provide an image in PNG, JPG or JPEG format.")])
