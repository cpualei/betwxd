...
def seed_users():
    ...
    Caitlin = User(
        username='Caitlin', email='caitlin@aa.io', password='password', profile_photo='https://caitlinbuenlucas.com/img/me.png', bio='Welcome to my full-stack pixel-perfect clone of Medium. Thanks for passing through.')
